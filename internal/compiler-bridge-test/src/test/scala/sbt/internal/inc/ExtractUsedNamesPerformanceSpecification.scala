...
class ExtractUsedNamesPerformanceSpecification
  ...
  it should "be executed in reasonable time" in {
    ...
    // format: off
    val expectedNamesForTupler212 = Set("$anon", "acme", "acme;Tupler;$anon;init;", "Aux", "DepFn1", "HList", "HNil",
"hnilTupler", "java;lang;Object;init;", "L", "Object", "Out", "Out0", "scala", "Serializable", "Tupler", "tupler",
"TuplerInstances", "Unit")
    val expectedNamesForTupler213 = Set("$anon", "_$3", "acme;Tupler;$anon;init;", "Aux", "Class", "DepFn1", "HList", "HNil", "hnilTupler",
...
"scala;runtime;ModuleSerializationProxy;init;", "Serializable", "T", "Tupler", "tupler", "TuplerInstances", "Unit")
    ...
    // format: on
    val expectedNamesForTupler =
      if (scalaVersion.startsWith("2.12")) expectedNamesForTupler212 else expectedNamesForTupler213

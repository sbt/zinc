...
class ExtractUsedNamesPerformanceSpecification
  ...
  it should "be executed in reasonable time" in {
    ...
    // format: off
    val expectedNamesForTupler = Set("_$3", "Tupler", "hnilTupler", "L", "Object", "Out0", "HList", "ModuleSerializationProxy", "java;lang;Object;init;", "tupler", "TuplerInstances", "DepFn1", "package", "HNil", "$anon", "Out", "T", "Aux", "scala", "Class", "Serializable", "scala;runtime;ModuleSerializationProxy;init;", "acme;Tupler;$anon;init;", "Unit")

...
import xsbti.compile.{ CompileSetup, CompileOptions }
...
object TextAnalysisFormatTest extends Properties("TextAnalysisFormat") {
  ...
  val commonSetup = new CompileSetup(dummyOutput, new CompileOptions(Array(), Array()), "2.10.4", xsbti.compile.CompileOrder.Mixed, nameHashing)

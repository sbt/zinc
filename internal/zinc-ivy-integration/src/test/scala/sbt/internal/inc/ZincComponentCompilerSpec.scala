...
class ZincComponentCompilerSpec extends BridgeProviderSpecification {
  ...
  it should "compile the bridge for Scala 2.13.0-M4" in {
    IO.withTemporaryDirectory(t => getCompilerBridge(t, logger, scala2130M4) should exist)
  }
}

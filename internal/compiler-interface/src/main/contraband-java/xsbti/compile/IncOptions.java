...
public final class IncOptions implements java.io.Serializable {
    ...
    public static boolean defaultStoreSymbolIndex() {
        return true;
    }
    ...
    public static IncOptions create(int _transitiveStep, double _recompileAllFraction, boolean _relationsDebug, boolean _apiDebug, int _apiDiffContextSize, java.util.Optional<java.io.File> _apiDumpDirectory, java.util.Optional<ClassFileManagerType> _classfileManagerType, boolean _useCustomizedFileManager, java.util.Optional<Boolean> _recompileOnMacroDef, boolean _useOptimizedSealed, boolean _storeApis, boolean _storeSymbolIndex, boolean _enabled, java.util.Map<String,String> _extra, boolean _logRecompileOnMacro, xsbti.compile.ExternalHooks _externalHooks) {
        return new IncOptions(_transitiveStep, _recompileAllFraction, _relationsDebug, _apiDebug, _apiDiffContextSize, _apiDumpDirectory, _classfileManagerType, _useCustomizedFileManager, _recompileOnMacroDef, _useOptimizedSealed, _storeApis, _storeSymbolIndex, _enabled, _extra, _logRecompileOnMacro, _externalHooks);
    }
    ...
    /** Determines whether incremental compiler stores symbol index alongside analysis. */
    private boolean storeSymbolIndex;
    ...
    protected IncOptions() {
        ...
        storeSymbolIndex = xsbti.compile.IncOptions.defaultStoreSymbolIndex();
    ...
    protected IncOptions(int _transitiveStep, double _recompileAllFraction, boolean _relationsDebug, boolean _apiDebug, int _apiDiffContextSize, java.util.Optional<java.io.File> _apiDumpDirectory, java.util.Optional<ClassFileManagerType> _classfileManagerType, boolean _useCustomizedFileManager, java.util.Optional<Boolean> _recompileOnMacroDef, boolean _useOptimizedSealed, boolean _storeApis, boolean _storeSymbolIndex, boolean _enabled, java.util.Map<String,String> _extra, boolean _logRecompileOnMacro, xsbti.compile.ExternalHooks _externalHooks) {
        ...
        storeSymbolIndex = _storeSymbolIndex;
        enabled = _enabled;
        extra = _extra;
    ...
    public boolean storeSymbolIndex() {
        return this.storeSymbolIndex;
    }
    ...
    public IncOptions withTransitiveStep(int transitiveStep) {
        return new IncOptions(transitiveStep, recompileAllFraction, relationsDebug, apiDebug, apiDiffContextSize, apiDumpDirectory, classfileManagerType, useCustomizedFileManager, recompileOnMacroDef, useOptimizedSealed, storeApis, storeSymbolIndex, enabled, extra, logRecompileOnMacro, externalHooks);
    }
    ...
    public IncOptions withStoreSymbolIndex(boolean storeSymbolIndex) {
        return new IncOptions(transitiveStep, recompileAllFraction, relationsDebug, apiDebug, apiDiffContextSize, apiDumpDirectory, classfileManagerType, useCustomizedFileManager, recompileOnMacroDef, useOptimizedSealed, storeApis, storeSymbolIndex, enabled, extra, logRecompileOnMacro, externalHooks);
    }
